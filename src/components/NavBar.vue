<template>
  <div class=" bg-white top-0 w-full">
    <div >
        ...
        <h1 class="text-center font-righteous text-2xl" >Est. Jan 7, 1974</h1>
      </div>
      <div
        class=" bg-blue-800 flex items-center gap-10 h-20 mt-4 isolate"
      >
        <div class="pl-20">
          <img
            src="../assets/star-of-life-png-27565.png"
            width="100"
            height="100"
          />
        </div>
